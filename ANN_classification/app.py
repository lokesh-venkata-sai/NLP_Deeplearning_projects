...
def load_data():
    ...
    with open('../models/churn_label_encoder_gender.pkl', 'rb') as file:
        label_encoder_gender = pickle.load(file)

    with open('../models/churn_standard_scaler.pkl', 'rb') as file:
        scaler = pickle.load(file)
    
    return model, onehot_encoder_geo, label_encoder_gender, scaler

model, onehot_encoder_geo, label_encoder_gender, scaler = load_data()
